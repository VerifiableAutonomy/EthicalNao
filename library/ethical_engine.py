...
class ethical_engine():
    def __init__(self, robot_controller):
       ...
       # Subject to change
        ...
        #self.agent.add_condition_rule(self.agent.NOT(self.agent.B('human_in_danger')), self.own_goal_rule)#TODO the actual outcome should be the robot walks towards its goal
